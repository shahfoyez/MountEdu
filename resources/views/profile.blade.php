                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="about_us" name="about_us" class="form-control">{{ old('about_us', $provider->about_us ?? '') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="choose_us" class="form-label"><strong>Why Choose Us</strong></label>
                            <textarea id="choose_us" name="choose_us" class="form-control">{{ old('choose_us', $provider->choose_us ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
